...
@section('title', 'Add BOM Entry')

@section('content')
    <h1 class="mt-4">Add BOM Entry</h1>
    ...
    <div class="card mb-4">
        <div class="card-header"><i class="fas fa-plus me-1"></i> New BOM Entry</div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form method="POST" action="{{ url('/bom') }}" id="bomForm">
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <tbody>
                                @foreach ($materials as $material)
                                    @php $isOld = old("materials.{$material->id}.material_id"); @endphp
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control form-control-sm qty-input"
                                                ...
                                                value="{{ old("materials.{$material->id}.quantity_required") }}"
                                                {{ $isOld ? '' : 'disabled' }}>
                ...
                <button type="submit" class="btn btn-primary">Save BOM Entry</button>
