...
@section('content')
    <h1 class="mt-4">Add Raw Material</h1>
    ...
    <div class="card mb-4">
        <div class="card-header"><i class="fas fa-plus me-1"></i> New Raw Material</div>
        <div class="card-body">
            @if ($errors->any())
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01"
                            ...
                            name="min_stock_alert" value="{{ old('min_stock_alert', 10) }}" min="0">
