...
@section('content')
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('superadmin.activity-log') }}" class="row g-2 align-items-end">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <select name="company_id" class="form-select form-select-sm">
                        ...
                        @foreach ($companies as $c)
                            <option value="{{ $c->id }}" @selected(request('company_id') == $c->id)>{{ $c->company_name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-12 col-md-3 d-flex gap-2">
                    ...
                    <a href="{{ route('superadmin.activity-log') }}" class="btn btn-secondary btn-sm">Reset</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <span><i class="fas fa-history me-1"></i> All Activity ({{ $logs->total() }} records)</span>
        </div>
                ...
                <table class="table table-hover table-striped table-sm mb-0 align-middle">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th class="col-hide-mobile">Company</th>
                    ...
                    <tbody>
                        @forelse ($logs as $log)
                            <tr>
                                ...
                                <td class="small text-nowrap">{{ $log->company_name ?? '—' }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted py-3">No activity logs found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
